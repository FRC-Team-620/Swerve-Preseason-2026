...
public class ModuleIOSimRev implements ModuleIO {
        ...
        driveSim =
            new DCMotorSim(
                LinearSystemId.createDCMotorSystem(
                    ...
                    0.025, //TODO why this value? what does it do?
                    DriveConstants.revConstants.driveMotorReduction),
                    DriveConstants.revConstants.driveGearbox
                );
        turnSim =
            new DCMotorSim(
                LinearSystemId.createDCMotorSystem(DriveConstants.revConstants.turnGearbox,
                0.004,
    ...
    public void setDriveVelocity(double velocityRadPerSec){
      ...
      driveFFVolts = DriveConstants.revConstants.driveSimKs * Math.signum(velocityRadPerSec)
