...
public class ModuleRev {
    ...
    public void periodic() {
        ...
        odometryPositions = new SwerveModulePosition[sample];
        for(int i = 0; i < sampleCount; i++){
            double positionMeters = inputs.odometryTurnPositionsRad[i] * revConstants.wheelRadiusMeters;
    ...
    public SwerveModulePosition[] getOdometyPositions(){
